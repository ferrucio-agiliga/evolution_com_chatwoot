...
Esse script vai criar todos os containers seguindo o arquivo docker-compose.yml...

+++ Considerações finais +++
!!! Para criar a instância do chatwoot, será necessário antes acessar o chatwoot e criar sua conta para obter o token do usuário...
